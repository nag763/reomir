...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100 font-mono flex">
            ...
            <div className="flex-1 ml-16 flex flex-col h-screen"> {/* Ensure ml-16 is correct */}
                <TopBar user={user} />

                {/* Page Content */}
                <main className="flex-1 p-6 md:p-8 overflow-y-auto"> {/* Added <main> and padding */}
                    ...
                    <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                            <h2 className="text-xl font-semibold mb-3">GitHub Vulnerabilities</h2>
